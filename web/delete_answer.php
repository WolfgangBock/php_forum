<?php
  ...
  if(isset($_GET['thread_id']) || isset($_POST['delete_id'])){
    ...
    if(isset($_POST['delete_id'])){
      ...
      if($logged_in){
        $result = delete_thread($question_id);
          
        if($result){
          $thread_deleted = true;
          $msg .= "Sie haben die Antwort erfolgreich gelöscht.</br>";
        }else{
  ...
  <body>
    ...
    <?php if(!$thread_deleted){ ?>  
      ...
      <div class="page-header">
        <h1>Sie möchten folgende Antwort löschen</h1>
      ...
      <form action="<?php echo $_SERVER['PHP_SELF']?>" method="post">
        ...
        <input type="submit" name="question_delete" class="btn btn-danger" value="Antwort löschen">
      </form>
